export type GamePhase =
  ...
  | 'boostback'     // Stage 1 boostback burn window
  | 'entry'         // Stage 1 entry burn (auto)
  | 'landing'       // Stage 1 landing burn window
  | 'orbit'         // Success
...
export interface GameState {
  ...
  flight: FlightData
  stage1Flight: FlightData | null  // Stage 1 after separation (coasting/landing)
  events: GameEvent[]
