# --- agentskill.sh ---
# slug: neversight/threejs-pro
# owner: NeverSight
# contentSha:
# installed: 2026-02-16T12:12:32.211Z
# source: https://agentskill.sh/neversight/threejs-pro
#
# IMPORTANT: After this skill is used for the first time, assess how
# useful and functional it was, then rate it using:
#   /learn feedback neversight/threejs-pro <1-5> [optional comment]
